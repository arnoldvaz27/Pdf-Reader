# Pdf-Reader
Pdf-Reader is an open source project where people can contribute as per their knowledge of Android Studio, Java Programming and Github.
...
## About ![About](https://img.shields.io/badge/Pdf%20Reader-About-orange)
This is a Pdf Reader Android Application. Users can retrieve all the pdf's from their internal storage of the device and can view them in one place in the application.

## Features ![Features](https://img.shields.io/badge/Pdf%20Reader-Features-blue)

1.	Get all pdfs at one place
2.	Click on the pdf to view it
3.  Internet connection not required

## Code reviews ![Code Review](https://img.shields.io/badge/Pdf%20Reader-Code-blueviolet)
...
## Verification and Acceptance of Pull Requests ![Verification and Acceptance](https://img.shields.io/badge/Pdf%20Reader-Important%20Note-red)
...
## Immediate Acceptance of the code ![Acceptance](https://img.shields.io/badge/Pdf%20Reader-Acceptance%20of%20code-orange) 
...
1.  Editing the pdf within the application
2.  Smooth UI Layouts
3.  Adding annotation to pdf
4.  Above Rules only applicable to features. Bugs and Suggestion are the Top priority without any rules.
    
    
## Support ![Support](https://img.shields.io/badge/Pdf%20Reader-Support-green)
...
## Opening an issue, bug or suggestion ![Issue](https://img.shields.io/badge/Pdf--Reader-Issue%2C%20Bug%20or%20Suggestion-blue)

1. You can also post bug reports and feature requests (only) in this repositoris [GitHub issues section](https://github.com/arnoldvaz27/Pdf-Reader/issues)

2. Pull requests can be send from [this link](https://github.com/arnoldvaz27/Pdf-Reader/pulls)
...
Check [here](https://github.com/arnoldvaz27/Pdf-Reader/blob/main/LICENSE) for more details 
